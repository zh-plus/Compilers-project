...
void project3(const string &input) {
	SPL::SPL_Driver driver;
	driver.parse(input.c_str());
...
void check_test3() {
	...
	/* b... files */
	for (int i = 1; i <= 5; ++i) {
		test_spl_path = "test3/test_3_b" + leading_zero(i) + ".spl";
		test_output_name = "test_3_b" + leading_zero(i) + ".ir";
		test_output_path = "test3/" + test_output_name;
		test_ans_path = "test3/answer/" + test_output_name;

		project3(test_spl_path);
	...
	/* r... files */
	for (int i = 1; i <= 10; ++i) {
		test_spl_path = "test3/test_3_r" + leading_zero(i) + ".spl";
		test_output_name = "test_3_r" + leading_zero(i) + ".ir";
		test_output_path = "test3/" + test_output_name;
		test_ans_path = "test3/answer/" + test_output_name;
