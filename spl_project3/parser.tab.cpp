...
#line 158 "/mnt/e/C++/compiler/compilers/spl_project3/parser.tab.cpp" // lalr1.cc:479
  ...
  `---------------*/
	...
	template<typename Base>
	inline
	SPL_Parser::basic_symbol<Base>::basic_symbol(typename Base::kind_type t, const semantic_type &v,
	...
	template<typename Base>
	SPL_Parser::basic_symbol<Base>::basic_symbol(typename Base::kind_type t, const CompSt_Node *v,
	                                             const location_type &l)
			: Base(t), value(v), location(l) {}

	template<typename Base>
	SPL_Parser::basic_symbol<Base>::basic_symbol(typename Base::kind_type t, const DecList_Node *v,
	                                             const location_type &l)
			: Base(t), value(v), location(l) {}
	...
	template<typename Base>
	SPL_Parser::basic_symbol<Base>::basic_symbol(typename Base::kind_type t, const DefList_Node *v,
	                                             const location_type &l)
			: Base(t), value(v), location(l) {}
	...
	template<typename Base>
	SPL_Parser::basic_symbol<Base>::basic_symbol(typename Base::kind_type t, const ExtDecList_Node *v,
	                                             const location_type &l)
			: Base(t), value(v), location(l) {}

	template<typename Base>
	SPL_Parser::basic_symbol<Base>::basic_symbol(typename Base::kind_type t, const ExtDefList_Node *v,
	                                             const location_type &l)
			: Base(t), value(v), location(l) {}

	template<typename Base>
	SPL_Parser::basic_symbol<Base>::basic_symbol(typename Base::kind_type t, const ExtDef_Node *v,
	                                             const location_type &l)
			: Base(t), value(v), location(l) {}

	template<typename Base>
	SPL_Parser::basic_symbol<Base>::basic_symbol(typename Base::kind_type t, const FunDec_Node *v,
	                                             const location_type &l)
			: Base(t), value(v), location(l) {}

	template<typename Base>
	SPL_Parser::basic_symbol<Base>::basic_symbol(typename Base::kind_type t, const ParamDec_Node *v,
	                                             const location_type &l)
			: Base(t), value(v), location(l) {}

	template<typename Base>
	SPL_Parser::basic_symbol<Base>::basic_symbol(typename Base::kind_type t, const Program_Node *v,
	                                             const location_type &l)
			: Base(t), value(v), location(l) {}
	...
	template<typename Base>
	SPL_Parser::basic_symbol<Base>::basic_symbol(typename Base::kind_type t, const Specifier_Node *v,
	                                             const location_type &l)
			: Base(t), value(v), location(l) {}

	template<typename Base>
	SPL_Parser::basic_symbol<Base>::basic_symbol(typename Base::kind_type t, const StmtList_Node *v,
	                                             const location_type &l)
			: Base(t), value(v), location(l) {}
	...
	template<typename Base>
	SPL_Parser::basic_symbol<Base>::basic_symbol(typename Base::kind_type t, const StructSpecifier_Node *v,
	                                             const location_type &l)
			: Base(t), value(v), location(l) {}

	template<typename Base>
	SPL_Parser::basic_symbol<Base>::basic_symbol(typename Base::kind_type t, const VarDec_Node *v,
	                                             const location_type &l)
			: Base(t), value(v), location(l) {}

	template<typename Base>
	SPL_Parser::basic_symbol<Base>::basic_symbol(typename Base::kind_type t, const VarList_Node *v,
	                                             const location_type &l)
			: Base(t), value(v), location(l) {}
...
#endif
							yylhs.value.as<Program_Node *>() = new Program_Node(
									yystack_[0].value.as<ExtDefList_Node *>());
...
#endif
							yylhs.value.as<ExtDefList_Node *>() = new ExtDefList_Node(
									yystack_[1].value.as<ExtDef_Node *>(), yystack_[0].value.as<ExtDefList_Node *>());
						}
...
#endif
							yylhs.value.as<ExtDef_Node *>() = new ExtDef_Node(yystack_[2].value.as<Specifier_Node *>(),
							                                                  yystack_[1].value.as<ExtDecList_Node *>(),
							                                                  make_leaf(token::SEMI,
							                                                            yystack_[0].value.as<Scan_Info *>()));
						}
...
#line 150 "parser.y" // lalr1.cc:859
						{
							...
							yylhs.value.as<ExtDef_Node *>() = new ExtDef_Node(yystack_[1].value.as<Specifier_Node *>(),
							                                                  yystack_[0].value.as<ExtDecList_Node *>(),
							                                                  make_leaf(token::SEMI, ";",
							                                                            yystack_[0].value.as<ExtDecList_Node *>()->propagate_line_no()));
						}
...
#line 164 "parser.y" // lalr1.cc:859
						{
							...
							yylhs.value.as<ExtDef_Node *>() = new ExtDef_Node(yystack_[0].value.as<Specifier_Node *>(),
							                                                  make_leaf(token::SEMI, ";",
							                                                            yystack_[0].value.as<Specifier_Node *>()->propagate_line_no()));
						}
...
#endif
							yylhs.value.as<ExtDef_Node *>() = new ExtDef_Node(yystack_[2].value.as<Specifier_Node *>(),
							                                                  yystack_[1].value.as<FunDec_Node *>(),
							                                                  yystack_[0].value.as<CompSt_Node *>());
						}
...
#endif
							yylhs.value.as<ExtDecList_Node *>() = new ExtDecList_Node(
									yystack_[0].value.as<VarDec_Node *>());
						}
...
#endif
							yylhs.value.as<ExtDecList_Node *>() = new ExtDecList_Node(
									yystack_[2].value.as<VarDec_Node *>(),
...
#line 192 "parser.y" // lalr1.cc:859
						{
							...
							yylhs.value.as<ExtDecList_Node *>() = new ExtDecList_Node(
									yystack_[1].value.as<VarDec_Node *>(), make_leaf(token::COMMA, ";",
									                                                 yystack_[0].value.as<ExtDecList_Node *>()->propagate_line_no()),
									yystack_[0].value.as<ExtDecList_Node *>());
						}
...
#endif
							yylhs.value.as<Specifier_Node *>() = new Specifier_Node(
									make_leaf(token::TYPE, yystack_[0].value.as<Scan_Info *>()));
						}
...
#endif
							yylhs.value.as<Specifier_Node *>() = new Specifier_Node(
									yystack_[0].value.as<StructSpecifier_Node *>());
						}
...
#endif
							yylhs.value.as<StructSpecifier_Node *>() = new StructSpecifier_Node(
									make_leaf(token::STRUCT, yystack_[4].value.as<Scan_Info *>()),
...
#line 229 "parser.y" // lalr1.cc:859
						{
							...
							yylhs.value.as<StructSpecifier_Node *>() = new StructSpecifier_Node(
									make_leaf(token::STRUCT, yystack_[3].value.as<Scan_Info *>()),
									...
									make_leaf(token::RC, "}",
									          yystack_[0].value.as<DefList_Node *>()->propagate_line_no()));
						}
...
#endif
							yylhs.value.as<StructSpecifier_Node *>() = new StructSpecifier_Node(
									make_leaf(token::STRUCT, yystack_[1].value.as<Scan_Info *>()),
...
#endif
							yylhs.value.as<VarDec_Node *>() = new ID_VarDec_Node(
									make_leaf(token::ID, yystack_[0].value.as<Scan_Info *>()));
						}
...
#endif
							yylhs.value.as<VarDec_Node *>() = new Array_VarDec_Node(
									yystack_[3].value.as<VarDec_Node *>(),
...
#endif
							yylhs.value.as<FunDec_Node *>() = new FunDec_Node(
									make_leaf(token::ID, yystack_[3].value.as<Scan_Info *>()),
...
#line 289 "parser.y" // lalr1.cc:859
						{
							...
							yylhs.value.as<FunDec_Node *>() = new FunDec_Node(
									...
									make_leaf(token::RP, ")",
									          yystack_[0].value.as<VarList_Node *>()->propagate_line_no()));
						}
...
#line 307 "parser.y" // lalr1.cc:859
						{
							...
							yylhs.value.as<FunDec_Node *>() = new FunDec_Node(
									make_leaf(token::ID, yystack_[1].value.as<Scan_Info *>()),
...
#line 319 "parser.y" // lalr1.cc:859
						{
							...
							yylhs.value.as<VarList_Node *>() = new VarList_Node(yystack_[2].value.as<ParamDec_Node *>(),
							                                                    make_leaf(token::COMMA,
							                                                              yystack_[1].value.as<Scan_Info *>()),
							                                                    yystack_[0].value.as<VarList_Node *>());
						}
...
#endif
							yylhs.value.as<VarList_Node *>() = new VarList_Node(
									yystack_[0].value.as<ParamDec_Node *>());
						}
...
#endif
							yylhs.value.as<ParamDec_Node *>() = new ParamDec_Node(
									yystack_[1].value.as<Specifier_Node *>(), yystack_[0].value.as<VarDec_Node *>());
						}
...
#endif
							yylhs.value.as<CompSt_Node *>() = new CompSt_Node(
									make_leaf(token::LC, yystack_[3].value.as<Scan_Info *>()),
...
#line 356 "parser.y" // lalr1.cc:859
						{
							...
							yylhs.value.as<CompSt_Node *>() = new CompSt_Node(
									...
									make_leaf(token::RC, "}",
									          yystack_[0].value.as<StmtList_Node *>()->propagate_line_no()));
						}
...
#endif
							yylhs.value.as<StmtList_Node *>() = new StmtList_Node(yystack_[1].value.as<Stmt_Node *>(),
							                                                      yystack_[0].value.as<StmtList_Node *>());
						}
...
#endif
							yylhs.value.as<Stmt_Node *>() = new Return_Stmt_Node(
									make_leaf(token::RETURN, yystack_[2].value.as<Scan_Info *>()),
...
#line 414 "parser.y" // lalr1.cc:859
						{
							...
							driver.add_syntax_error(";", yystack_[1].value.as<Scan_Info *>());
							yylhs.value.as<Stmt_Node *>() = new Return_Stmt_Node(
									make_leaf(token::RETURN, yystack_[1].value.as<Scan_Info *>()),
									yystack_[0].value.as<Exp_Node *>(),
									make_leaf(token::SEMI, ";",
									          yystack_[0].value.as<Exp_Node *>()->propagate_line_no()));
						}
...
#endif
							yylhs.value.as<Stmt_Node *>() = new If_Stmt_Node(
									make_leaf(token::IF, yystack_[4].value.as<Scan_Info *>()),
...
#line 433 "parser.y" // lalr1.cc:859
						{
							...
							driver.add_syntax_error(")", yystack_[3].value.as<Scan_Info *>());
							yylhs.value.as<Stmt_Node *>() = new If_Stmt_Node(
									make_leaf(token::IF, yystack_[3].value.as<Scan_Info *>()),
									make_leaf(token::LP, yystack_[2].value.as<Scan_Info *>()),
									yystack_[1].value.as<Exp_Node *>(),
...
#endif
							yylhs.value.as<Stmt_Node *>() = new If_Stmt_Node(
									make_leaf(token::IF, yystack_[6].value.as<Scan_Info *>()),
...
#line 456 "parser.y" // lalr1.cc:859
						{
							...
							yylhs.value.as<Stmt_Node *>() = new If_Stmt_Node(
									make_leaf(token::IF, yystack_[5].value.as<Scan_Info *>()),
...
#endif
							yylhs.value.as<Stmt_Node *>() = new While_Stmt_Node(
									make_leaf(token::WHILE, yystack_[4].value.as<Scan_Info *>()),
									make_leaf(token::LP, yystack_[3].value.as<Scan_Info *>()),
									yystack_[2].value.as<Exp_Node *>(),
									make_leaf(token::RP, yystack_[1].value.as<Scan_Info *>()),
									yystack_[0].value.as<Stmt_Node *>());
...
#line 479 "parser.y" // lalr1.cc:859
						{
							...
							driver.add_syntax_error(")", yystack_[3].value.as<Scan_Info *>());
							yylhs.value.as<Stmt_Node *>() = new While_Stmt_Node(
									make_leaf(token::WHILE, yystack_[3].value.as<Scan_Info *>()),
									make_leaf(token::LP, yystack_[2].value.as<Scan_Info *>()),
									yystack_[1].value.as<Exp_Node *>(),
									make_leaf(token::RP, ")", yystack_[1].value.as<Exp_Node *>()->propagate_line_no()),
									yystack_[0].value.as<Stmt_Node *>());
...
#endif
							yylhs.value.as<DefList_Node *>() = new DefList_Node(yystack_[1].value.as<Def_Node *>(),
							                                                    yystack_[0].value.as<DefList_Node *>());
						}
...
#line 518 "parser.y" // lalr1.cc:859
						{
							...
							yylhs.value.as<Def_Node *>() = new Def_Node(yystack_[1].value.as<Specifier_Node *>(),
							                                            ...
							                                            make_leaf(token::SEMI, ";",
							                                                      yystack_[0].value.as<DecList_Node *>()->propagate_line_no()));
						}
...
#endif
							yylhs.value.as<Exp_Node *>() = new Binary_Exp_Node(yystack_[2].value.as<Exp_Node *>(),
							                                                   make_leaf(token::ASSIGN,
							                                                             yystack_[1].value.as<Scan_Info *>()),
							                                                   yystack_[0].value.as<Exp_Node *>());
						}
...
#endif
							yylhs.value.as<Exp_Node *>() = new Parentheses_Exp_Node(
									make_leaf(token::LP, yystack_[2].value.as<Scan_Info *>()),
									yystack_[1].value.as<Exp_Node *>(),
									make_leaf(token::RP, yystack_[0].value.as<Scan_Info *>()));
						}
...
#endif
							yylhs.value.as<Exp_Node *>() = new Unary_Exp_Node(
									make_leaf(token::MINUS, yystack_[1].value.as<Scan_Info *>()),
									yystack_[0].value.as<Exp_Node *>());
						}
...
#endif
							yylhs.value.as<Exp_Node *>() = new Unary_Exp_Node(
									make_leaf(token::NOT, yystack_[1].value.as<Scan_Info *>()),
									yystack_[0].value.as<Exp_Node *>());
						}
...
#endif
							yylhs.value.as<Exp_Node *>() = new ID_Parentheses_Exp_Node(
									make_leaf(token::ID, yystack_[3].value.as<Scan_Info *>()),
									make_leaf(token::LP, yystack_[2].value.as<Scan_Info *>()),
...
#line 688 "parser.y" // lalr1.cc:859
						{
							...
							yylhs.value.as<Exp_Node *>() = new ID_Parentheses_Exp_Node(
									...
									make_leaf(token::RP, ")",
									          yystack_[0].value.as<Args_Node *>()->propagate_line_no()));
						}
...
#endif
							yylhs.value.as<Exp_Node *>() = new Leaf_Exp_Node(
									make_leaf(token::ID, yystack_[0].value.as<Scan_Info *>()));
						}
...
#endif
							yylhs.value.as<Exp_Node *>() = new Leaf_Exp_Node(
									make_leaf(token::FLOAT, yystack_[0].value.as<Scan_Info *>()));
						}
...
#endif
							yylhs.value.as<Exp_Node *>() = new Leaf_Exp_Node(
									make_leaf(token::CHAR, yystack_[0].value.as<Scan_Info *>()));
						}
...
#endif
							yylhs.value.as<Exp_Node *>() = new Leaf_Exp_Node(
									make_leaf(token::ERROR, yystack_[0].value.as<Scan_Info *>()));
						}
...
#endif
							yylhs.value.as<Args_Node *>() = new Args_Node(yystack_[2].value.as<Exp_Node *>(),
							                                              make_leaf(token::COMMA,
							                                                        yystack_[1].value.as<Scan_Info *>()),
							                                              yystack_[0].value.as<Args_Node *>());
						}
