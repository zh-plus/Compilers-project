...
namespace SPL {
	...
	public:
		Specifier_Node *specifier = nullptr;
		ExtDecList_Node *ext_dec_list = nullptr;
		Leaf_Node *semi = nullptr;

		FunDec_Node *fun_dec = nullptr;
		CompSt_Node *comp_st = nullptr;

		ExtDef_Node(Specifier_Node *specifier, ExtDecList_Node *ext_dec_list, Leaf_Node *semi)
				: specifier{specifier}, ext_dec_list{ext_dec_list}, semi{semi} {};

		ExtDef_Node(Specifier_Node *specifier, Leaf_Node *semi)
				: specifier{specifier}, semi{semi} {};

		ExtDef_Node(Specifier_Node *specifier, FunDec_Node *fun_dec, CompSt_Node *comp_st)
				: specifier{specifier}, fun_dec{fun_dec}, comp_st{comp_st} {};
