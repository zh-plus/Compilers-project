...
namespace SPL {
	...
	public:
		...
		virtual E visit(Dec_Node *node) = 0;
	...
	class Visitor : public AST_Visitor<void, void, void> {
	public:
		/* Internal Nodes */
		...
		/* Expression Node */
		void visit(Parentheses_Exp_Node *node) override;

		void visit(ID_Parentheses_Exp_Node *node) override;

		void visit(Bracket_Exp_Node *node) override;

		void visit(Dot_Exp_Node *node) override;

		void visit(Binary_Exp_Node *node) override;

		void visit(Unary_Exp_Node *node) override;

		void visit(Leaf_Exp_Node *node) override;
